...
public class Enrollment {
    ...
    public EnrollmentDTO DTOmapper(boolean isComplete){
        ...
        return EnrollmentDTO.builder()
                            ...
                            .gradeLevelToEnroll(Optional.ofNullable(gradeLevelToEnroll).map(GradeLevel::getLevelName).orElse("N/A"))
    ...
    public EnrollmentDTO DTOmapper(){
        ...
        return EnrollmentDTO.builder()
                ...
                .gradeLevelToEnrollId(Optional.ofNullable(gradeLevelToEnroll).map(GradeLevel::getLevelId).orElse(null))
                .gradeLevelToEnroll(Optional.ofNullable(gradeLevelToEnroll).map(GradeLevel::getLevelName).orElse("N/A"))
                .sectionToEnroll(Optional.ofNullable(sectionToEnroll).map(Section::getSectionName).orElse("N/A"))
                .enrollmentStatus(enrollmentStatus)
                .studentMiddleName(student.getMiddleName())
                .remarks(remarks)
                .studentMiddleName(student.getMiddleName())
